...
shop-billing/
│
├── index.html      # The complete app (UI + logic) — open this to run it
└── README.md        # This file
```

As new files are added (backup export, logo, PWA files, etc.), they'll be listed here and in the Day-wise Log below.
